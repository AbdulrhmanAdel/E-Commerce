...
namespace API.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            var user =await _userManager.FindUserByClaimsPrinciples(HttpContext.User);
        ...
        {
            var user = await _userManager.FindUserByClaimsPrincilesWithAddressAsync(HttpContext.User);
